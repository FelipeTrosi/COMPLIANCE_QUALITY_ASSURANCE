...
public class Carro {
	...
	public Carro(int codigo, String nome, String marca, String placa, int ano, Transmissão cambio, byte[] documento) {
		super();
		this.codigo = codigo;
		this.nome = nome;
		this.marca = marca;
	...
	public Carro(String nome, String marca, String placa, int ano, Transmissão cambio, Calendar dataFabricacao,
			byte[] documento) {
		super();
		this.nome = nome;
		this.marca = marca;
	...
	public Transmissão getCambio() {
		return cambio;
	}

	public void setCambio(Transmissão cambio) {
		this.cambio = cambio;
	}
